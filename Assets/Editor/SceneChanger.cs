...
namespace SVerdeTools.SceneChanger{
    ...
    public class SceneChanger : EditorWindow{
        ...
        [MenuItem("SVerde Tools/Scene Changer %#e")]
        ...
        void OnEnable()
        {
            onlyInBuildSettings = EditorPrefs.GetBool("OnlyInBuildSettings");
            Reload();
        }
        ...
        void OnGUI()
        {
            ...
            if (EditorGUI.EndChangeCheck()) {
                EditorPrefs.SetBool("OnlyInBuildSettings", onlyInBuildSettings);
                Reload();
            }
